...
const textureURL = 'https://rawcdn.githack.com/ricardoolivaalonso/ThreeJS-Room14/a50f65020e8781fc118b6626a3bd6044482dd478/static/baked.jpg'
const textureNightURL = 'https://rawcdn.githack.com/ricardoolivaalonso/ThreeJS-Room14/a50f65020e8781fc118b6626a3bd6044482dd478/static/baked-night.jpg'

// ====================================
// ====================================
function handleLoadRoom () {
    loader.load('https://rawcdn.githack.com/ricardoolivaalonso/ThreeJS-Room14/a50f65020e8781fc118b6626a3bd6044482dd478/static/room.glb', (gltf) => {
        room = gltf.scene
        applyTexture(room, textureURL, .1, .75)
        scene.add(room)
...
function handleLoadModels() {
    ...
    loader.load('https://rawcdn.githack.com/ricardoolivaalonso/ThreeJS-Room14/a50f65020e8781fc118b6626a3bd6044482dd478/static/lampara.glb', (gltf) => {
        lampara = gltf.scene
        applyTexture(lampara, textureURL, .1, .5)
        lampara.position.sub(new THREE.Vector3(1.25, -1.1, .25))
        scene.add(lampara)
    })

    loader.load('https://rawcdn.githack.com/ricardoolivaalonso/ThreeJS-Room14/a50f65020e8781fc118b6626a3bd6044482dd478/static/robot.glb', (gltf) => {
        robot = gltf.scene
    ...
    loader.load('https://rawcdn.githack.com/ricardoolivaalonso/ThreeJS-Room14/a50f65020e8781fc118b6626a3bd6044482dd478/static/sillon.glb', (gltf) => {
        sillon = gltf.scene
    ...
    loader.load('https://rawcdn.githack.com/ricardoolivaalonso/ThreeJS-Room14/a50f65020e8781fc118b6626a3bd6044482dd478/static/lamparaBase.glb', (gltf) => {
    ...
    loader.load('https://rawcdn.githack.com/ricardoolivaalonso/ThreeJS-Room14/a50f65020e8781fc118b6626a3bd6044482dd478/static/book.glb', (gltf) => {
        book = gltf.scene
    ...
    loader.load('https://rawcdn.githack.com/ricardoolivaalonso/ThreeJS-Room14/a50f65020e8781fc118b6626a3bd6044482dd478/static/silla.glb', (gltf) => {
        silla = gltf.scene
    ...
    loader.load('https://rawcdn.githack.com/ricardoolivaalonso/ThreeJS-Room14/a50f65020e8781fc118b6626a3bd6044482dd478/static/jarron01.glb', (gltf) => {
        jarron01 = gltf.scene
        applyTexture(jarron01, textureURL, .25, .5)
        jarron01.position.sub(new THREE.Vector3(-.7, -.15, 1.2))
        scene.add(jarron01)
    })

    loader.load('https://rawcdn.githack.com/ricardoolivaalonso/ThreeJS-Room14/a50f65020e8781fc118b6626a3bd6044482dd478/static/jarron02.glb', (gltf) => {
        jarron02 = gltf.scene
        applyTexture(jarron02, textureURL, .25, .5)
        jarron02.position.sub(new THREE.Vector3(1.5, -.77, 1.1))
        scene.add(jarron02)
    })

    loader.load('https://rawcdn.githack.com/ricardoolivaalonso/ThreeJS-Room14/a50f65020e8781fc118b6626a3bd6044482dd478/static/jarron03.glb', (gltf) => {
        jarron03 = gltf.scene
        applyTexture(jarron03, textureURL, .25, .5)
...
function onDocumentMouseMove(event) {
    ...
    const objectsToIntersect = [
        ...
        { object: sillon, name: 'Boucle Pouffe Footstool White TAMPA', description: 'Beautiful round pouffe finished in white boucle fabric, featuring classic button-tufting that blends well with any modern as well as traditional home décor. The upholstery is incredibly soft and at the same time wear-resistant and easy to clean. The footrest works great a complementary addition to a sofa in a similar design or a trendy extra seat for living area as well as master suite.' },
        { object: silla, name: 'Desk Chair Velvet Taupe VENICE', description: 'This modern yet classy desk armchair will perfectly blend in with any modern or Scandinavian inspired interior. Featuring tufted velvet upholstery, this chair is utterly pleasant to the touch. Its smart foam filling makes it extremely comfortable, while its sloped arms reflect the quality and support of a traditional armchair. Equipped with a height-adjustment as well as a 360’ swivel mechanism, this chair is incredibly practical and versatile.' },
